...
val demoNamespace by extra("dev.tclement.jlsplant.demo")
val libArtifactId by extra("jlsplant")
val libGroupId by extra("dev.tclement.jlsplant")
val libNamespace by extra("dev.tclement.jlsplant")
val libVersionCode by extra(40001)
val libVersionName by extra("4.0-01")
