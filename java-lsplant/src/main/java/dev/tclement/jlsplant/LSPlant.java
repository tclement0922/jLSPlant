...
public final class LSPlant {
    ...
    static {
        try {
            ...
            Log.e("Java-LSPlant", "Failed to load java_lsplant native lib.", e);
            isLibLoaded = false;
        }
    }
    ...
    public static class Hooker {
        ...
        private static Hooker hook(Object owner, Member target, Method replacement) {
            ...
            try {
                ...
                Log.e("Java-LSPlant", "Hooker.callback(...) method not found. Make sure Java-LSPlant is added to your proguard rules.", e);
                hooker = null;
            } catch (LSPlantHookFailed e) {
                Log.e("Java-LSPlant", "Unable to hook target.", e);
                hooker = null;
            }
            return hooker;
        }
